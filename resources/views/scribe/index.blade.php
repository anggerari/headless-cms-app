...
<head>
    ...
    <title>Headless CMS APP API Documentation</title>
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-v1-posts">Display a listing of the published posts.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-posts--slug-">
                                <a href="#endpoints-GETapi-v1-posts--slug-">Display a single, published post.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-pages">
                                <a href="#endpoints-GETapi-v1-pages">Display a listing of the published pages.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-pages--slug-">
                                <a href="#endpoints-GETapi-v1-pages--slug-">Display a single, published page.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-categories">
                                <a href="#endpoints-GETapi-v1-categories">Display a listing of all categories.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-categories--slug-">
                                <a href="#endpoints-GETapi-v1-categories--slug-">Display a single category.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-categories--category_slug--posts">
                                <a href="#endpoints-GETapi-v1-categories--category_slug--posts">Display all published posts for a given category.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="endpoints">Endpoints</h1>
                                ...
                                <h2 id="endpoints-GETapi-v1-posts">Display a listing of the published posts.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-posts--slug-">Display a single, published post.</h2>
...
<p>The slug of the post. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-pages">Display a listing of the published pages.</h2>
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;meta&quot;: {
        ...
        &quot;links&quot;: [
            ...
            {
                &quot;url&quot;: &quot;http://localhost:8000/api/v1/pages?page=1&quot;,
                &quot;label&quot;: &quot;1&quot;,
                &quot;active&quot;: true
            },
            {
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-pages--slug-">Display a single, published page.</h2>
...
<p>The slug of the page. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-categories">Display a listing of all categories.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-categories--slug-">Display a single category.</h2>
...
<p>The slug of the category. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-categories--category_slug--posts">Display all published posts for a given category.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/v1/categories/1/posts" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/v1/categories/1/posts"
);
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="category_slug"                data-endpoint="GETapi-v1-categories--category_slug--posts"
               value="1"
               data-component="url">
    <br>
<p>The slug of the category. Example: <code>1</code></p>
